...
namespace RaptorStreet.Controllers
{
    public class ClientesController : Controller
    {
        ...
        {
            //retorna view com erro intencionalmente, já que o banco não aceita nulo - obriga a retornar a página quebrada pra pode ir pro cadastro
            ...
            //atribui um cargo pro cliente, e ao invés de armazenar no banco, ele mesmo cria
        ...
        //pega a sessão que foi armazenada o cadastro e faz a verificação se você está logado e manda logar se não estiver
